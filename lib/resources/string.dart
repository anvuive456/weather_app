abstract final class AppString {
  ...
  static const String hintSearchLocation = 'London/51.52,-0.11';

  static const String settingLabelDegree = 'Degree';
  static const String settingLabelMeasure = 'Measure';

  static const String settingLabelLanguage = 'Language';
  ...
  static const String msgRefresh =
      'Something went wrong. Click here to refresh';

  static const String labelAirQualitiyIndex = 'Air Quality Index';
