...
class ForecastModel {
  final String date;
  final int dateEpoch;
  final DayForecastModel day;
  final AstroModel astro;
  final List<HourForecastModel> hour;
...
//<editor-fold desc="Data Methods">
  ...
  @override
  String toString() {
    return 'ForecastModel{ date: $date, dateEpoch: $dateEpoch, day: $day, astro: $astro, hour: $hour,}';
  }
  ...
  factory ForecastModel.fromMap(Map<String, dynamic> map) {
    return ForecastModel(
      ...
      day: DayForecastModel.fromMap(map['day']),
      astro: AstroModel.fromMap(map['astro']),
      hour: (map['hour'] as List)
          .map((e) => HourForecastModel.fromMap(e))
          .toList(),
    );
  }
  ...
  factory DayForecastModel.fromMap(Map<String, dynamic> map) {
    return DayForecastModel(
      ...
      airQuality: map['air_quality'] == null
          ? null
          : AirQualityModel.fromMap(map['air_quality']),
    );
  }
//</editor-fold>
}
...
//<editor-fold desc="Data Methods">
  ...
  @override
  String toString() {
    return 'HourForecastModel{ timeEpoch: $timeEpoch, time: $time, tempC: $tempC, tempF: $tempF, isDay: $isDay, condition: $condition,}';
  }

  factory HourForecastModel.fromMap(Map<String, dynamic> map) {
