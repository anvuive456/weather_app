...
//<editor-fold desc="Data Methods">
  ...
  const WeatherModel.empty({
    ...
    this.tempF = 0.0,
    this.isDay = 0,
    this.condition = const ConditionModel.empty(),
    this.windMph = 0.0,
    this.windKph = 0.0,
    this.windDegree = 0,
    this.windDir = '',
...
//<editor-fold desc="Data Methods">
  ...
  @override
  String toString() {
    return 'AirQualityModel{ co: $co, no2: $no2, o3: $o3, so2: $so2, pm25: $pm25, pm10: $pm10, usEpaIndex: $usEpaIndex, gbDefraIndex: $gbDefraIndex,}';
  }
  ...
  factory AirQualityModel.fromMap(Map<String, dynamic> map) {
